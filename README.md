...
### Date Inițiale:
La pornire, aplicația încarcă automat date din `tastatura.txt`:
- 3+ zboruri pre-configurate
- Pasageri înregistrați cu bilete
- Diverse clase și configurații
### Date finale:
- Salvare automată la ieșire în `tastatura2.txt`
...
└── tastatura.txt            # Date intiale
└── tastatura2.txt           # Salvare date dupa ce se inchide terminalul
```
-----
